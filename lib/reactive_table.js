...
var getSessionUseFontAwesomeKey = function () {
    return 'reactive-table-use-font-awesome';
};
...
if (Handlebars) {
    Handlebars.registerHelper('reactiveTable', function (collection, settings) {
		...
		Session.set(getSessionUseFontAwesomeKey(), settings.useFontAwesome ? "true" : "false");
...
Template.reactiveTable.helpers({
	...
	"useFontAwesome": function () {
		return Session.get(getSessionUseFontAwesomeKey()) === "true";
	},
