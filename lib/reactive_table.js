...
var setup = function () {
    ...
    context.sortKey = new ReactiveVar(sortKey);
    context.sortDirection = new ReactiveVar(sortDirection);
    ...
    context.visibleFields = new ReactiveVar(visibleFields);
    ...
    context.class = this.data.class || this.data.settings.class || 'table table-striped table-hover';
    ...
    context.rowsPerPage = new ReactiveVar(this.data.rowsPerPage || this.data.settings.rowsPerPage || 10);
    context.currentPage = new ReactiveVar(0);

    context.filter = new ReactiveVar(null);
