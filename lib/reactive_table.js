...
Template.reactiveTable.events({
    "click .reactive-table .sortable": function (event) {
        var sortIndex = parseInt($(event.currentTarget).attr("index"), 10);
        var group = $(event.currentTarget).parents('.reactive-table').attr('reactive-table-group');
