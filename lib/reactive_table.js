...
Template.reactiveTable.helpers({
    ...
    'addChildrenExpandIcon': function(){
        ...
        if (context.childrenKey != null && context.childrenExpandLabel === this.label){
            return true;
        }
    },
