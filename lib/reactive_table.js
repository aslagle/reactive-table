...
Template.reactiveTable.helpers({
    ...
    'isVisible': function () {
        var visibleFields = Template.parentData(1).visibleFields || Template.parentData(2).visibleFields;
        var fields = Template.parentData(1).fields || Template.parentData(2).fields;
