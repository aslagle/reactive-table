...
if (Meteor.isClient) {
  ReactiveTable2 = ReactiveTable2 || {};

  var reactiveTableFilters = {};
  var callbacks = {};

  ReactiveTable2.Filter = function (id, fields) {
  ...
  ReactiveTable2.clearFilters = function (filterIds) {
  ...
  getFilterStrings = function (filterIds) {
    return _.map(filterIds, function (filterId) {
      if (_.isUndefined(reactiveTableFilters[filterId])) {
        reactiveTableFilters[filterId] = new ReactiveTable2.Filter(filterId);
      }
  ...
  Template.reactiveTableFilter2.helpers({
    'class': function () {
    ...
    'filter': function () {
      if (_.isUndefined(reactiveTableFilters[this.id])) {
        new ReactiveTable2.Filter(this.id, this.fields);
  ...
  Template.reactiveTableFilter2.events({
